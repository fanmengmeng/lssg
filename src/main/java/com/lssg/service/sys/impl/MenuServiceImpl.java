...
import com.lssg.common.util.TreeUtils;
import com.lssg.dao.sys.MenuMapper;
import com.lssg.model.sys.Menu;
import com.lssg.pojo.Tree;
import com.lssg.service.iservice.impl.BaseService;
import com.lssg.service.sys.MenuService;
...
public class MenuServiceImpl extends BaseService<Menu> implements MenuService {
    ...
    public List<Menu> findAllMenus(Menu menu) {
        try {
            ...
            if (StringUtils.isNotBlank(menu.getMenuname())) {
                criteria.andCondition("menuname=", menu.getMenuname());
            }
    ...
    public Menu findByNameAndType(String menuName, String type) {
        Example example = new Example(Menu.class);
        example.createCriteria().andCondition("lower(menuname)=", menuName.toLowerCase())
