...
var deviceSerialId = 'C27548604';
function init(cal,ten) {

    var cal = $("#t1").val().replace(/\-| |:/g,"");
    var ten = $("#t2").val().replace(/\-| |:/g,"");
    var ten1 = 235959;
    var startTime =cal+ten;
    var endTime = cal+ten1;
    //var currentdatelong = currentdate.replace(/\-| |:/g,"");
    //var currentdatelong = new Date(currentdate.replace(new RegExp("-","gm"),"/")).getTime()     //当前时间转换成long型

    //?begin='+currentdatelong+'
    TestActiveX();
    var text = '{ \n' +
        ' "AppKey":"a91b14aa78b4491aae4eb83e7adefa22", \n' +
        ' "AccessToken":"at.1i8uo4k4a1bmrtzl686wzlzn123jqrkq-2o946uz0im-07o8jvg-eyjtrnfp2", \n' +
        ' "Url":"ezopen://open.ys7.com/'+deviceSerialId+'/1.rec?begin='+startTime+'&end='+endTime+'" \n}';
